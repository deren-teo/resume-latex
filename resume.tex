...
% - Remove "magic numbers" defining size & position of shaded grey section
...
\hspace{-2cm} % position light grey background effect at the very left margin
\colorbox{f2f2f2}{
\begin{minipage}[t][23cm]{0.39\textwidth}
  ...
  \hspace{1.6cm}  % nest another minipage for the content, regularly aligned
...
\begin{minipage}[t][23cm]{0.61\textwidth}
  ...
  \begin{section}{Profile}
    ...
    \vspace{-1pt} % modify spacing to align horizontal divider w/ Contact section
  \end{section}
...
\hspace{-2cm} % position light grey background effect at the very left margin
\colorbox{f2f2f2}{
\begin{minipage}[t][21.5cm]{0.4\textwidth}
  ...
  \hspace{1.6cm}  % nest another minipage for the content, regularly aligned
  \begin{minipage}[t][21.5cm]{0.7\textwidth}
...
\begin{minipage}[t][21.5cm]{0.61\textwidth}
